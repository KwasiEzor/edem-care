...
export function NavbarClient({ businessName, businessPhone, businessEmail, businessZone }: NavbarClientProps) {
        ...
        >
          <div className="hidden items-center justify-between border-b border-slate-200/80 px-5 py-2 text-xs text-muted-custom lg:flex">
            <div className="inline-flex items-center gap-2 font-medium text-forest">
              ...
              Soins infirmiers à domicile à {businessZone}
            </div>
            <div className="flex items-center gap-4">
              <a href={`tel:${phoneClean}`} className="transition-colors hover:text-forest">
                {businessPhone}
              </a>
            ...
            <div className="hidden items-center gap-3 lg:flex">
              <a
                ...
                className={cn(
                  ...
                  "h-10 rounded-full border-slate-300 bg-white px-4 text-ink shadow-sm hover:bg-slate-50"
                )}
              >
              ...
              <Link
                ...
                className={cn(
                  ...
                  "h-10 rounded-full bg-forest px-5 text-white shadow-lg shadow-blue-900/15 hover:bg-forest/90"
                )}
              >
                Prendre rendez-vous
                  ...
                  <div className="mt-4 space-y-3">
                    <a
                      ...
                      className={cn(
                        ...
                        "flex h-11 w-full items-center justify-center gap-2 rounded-full border-slate-300 bg-white"
                      )}
                    >
                      <Phone className="h-4 w-4" />
                      Appeler
                    ...
                    <Link
                      ...
                      className={cn(
                        buttonVariants(),
                        "flex h-11 w-full items-center justify-center gap-2 rounded-full bg-forest"
                      )}
                    >
                      Prendre rendez-vous
                    </Link>
